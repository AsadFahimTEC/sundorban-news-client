...
const Headline = () => {
  return (
    <div className="container mx-auto px-4 py-6 bg-gray-100">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Left Section: News List */}
        <div className="md:col-span-1 bg-white p-4 shadow-md border border-gray-300">
          <img
            src="https://i.ibb.co/xjThM10/Screenshot-2024-11-10-02-28-41-06-a23b203fd3aafc6dcb84e438dda678b6-1024x567.jpg"
            alt="Featured News"
          ...
          <ul className="space-y-3 text-gray-700">
            <li className="border-b pb-2 hover:bg-gray-200 cursor-pointer">
              <span className="text-red-600 font-bold">জাতীয়</span> সুন্দরবন
              নিউজ২৪ / নির্বাচিত প্রতিনিধি দেখতে চায় জাতি: আমীর খসরু
            </li>
            <li className="border-b pb-2 hover:bg-gray-200 cursor-pointer">
              <span className="text-red-600 font-bold">খেলাধুলা</span> নিউজ এইট
              / প্রাইম আর্টি ওয়ার্ড নিউজ২৪ তেলো নিউজ এইট
            </li>
            <li className="border-b pb-2 hover:bg-gray-200 cursor-pointer">
              <span className="text-red-600 font-bold">জাতীয়</span> নিউজ ফোর /
              প্রাইম আর্টি ওয়ার্ড নিউজ২৪ তেলো নিউজ ফোর
            </li>
            <li className="border-b pb-2 hover:bg-gray-200 cursor-pointer">
            ...
            <li className="hover:bg-gray-200 cursor-pointer">
              ...
              আর্টি ওয়ার্ড নিউজ২৪ তেলো নিউজ টু
            </li>
          </ul>
        </div>
        ...
        <div className="md:col-span-1 bg-white p-4 shadow-md border border-gray-300">
          ...
          <img
            src="https://i.ibb.co/xjThM10/Screenshot-2024-11-10-02-28-41-06-a23b203fd3aafc6dcb84e438dda678b6-1024x567.jpg"
            alt="Featured News"
            className="w-full h-auto mt-4 border-b-2 border-gray-300"
          />
