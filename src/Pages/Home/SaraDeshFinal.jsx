      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-1 space-y-4 cursor-pointer">
          <div className="flex flex-col">
            <img
              src="https://i.ibb.co/qgv03VL/Messenger-creation-2836-E514-6174-4-A1-D-BF97-6-C46-ED08082-D-1024x460.jpg"
              alt="News"
              className="w-full h-[150px] md:h-[180px] lg:h-[200px] object-cover rounded-md"
            />
          ...
          <div className="flex flex-col">
            <img
              src="https://i.ibb.co/k6PcxhR/IMG-20241201-183534.jpg"
              alt="News"
              className="w-full h-[150px] md:h-[180px] lg:h-[200px] object-cover rounded-md"
            />
            <p className="text-sm font-semibold mt-2">
        ...
        <div className="md:col-span-1 cursor-pointer">
          <img
            src="https://i.ibb.co/b1hRG47/IMG-20241209-163507-1024x770.jpg"
            alt="Main News"
            className="w-full h-[220px] sm:h-[250px] md:h-[280px] lg:h-[300px] object-cover rounded-md"
          />
          <h2 className="text-xl font-bold mt-2 leading-snug">
        ...
        <div className="md:col-span-1">
          <div className="border-b-2 border-red-500 pb-2 mb-2 cursor-pointer">
            <h3 className="text-lg font-bold text-red-600">
              রেকর্ড অঙ্কের টাকা মিলল
            </h3>
          </div>
          <ul className="space-y-2 text-sm">
            <li className="border-b pb-1 hover:text-red-500 cursor-pointer">
            ...
            <li className="border-b pb-1 hover:text-red-500 cursor-pointer">
              জামায়াত আমীর সাতক্ষীরায় আসছেন শনিবার, প্রস্তুতি পরিদর্শনে জেলা
              উজির
            </li>
